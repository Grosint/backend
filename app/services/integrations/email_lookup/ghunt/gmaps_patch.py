...
# Lock to synchronize access to _PATCH_APPLIED in concurrent/async imports
...
def apply_gmaps_patch() -> None:
    ...
    # Acquire lock to make check-and-set operations atomic
    with _PATCH_LOCK:
        if _PATCH_DISABLED:
