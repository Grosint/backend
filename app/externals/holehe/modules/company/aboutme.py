...
async def aboutme(email, client, out):
    ...
    try:
        reqToken = await client.get(
            "https://about.me/signup",
    ...
    data = (
        '{"user_name":"","first_name":"","last_name":"","allowed_features":[],"counters":{"id":"counters"},"settings":{"id":"settings","compliments":{"id":"compliments"},"follow":{"id":"follow"},"share":{"id":"share"}},"email_address":"'
        + email
    ...
    response = await client.post(
        "https://about.me/n/signup", headers=headers, data=data
    )
